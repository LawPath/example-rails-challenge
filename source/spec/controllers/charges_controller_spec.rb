  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved charge as @charge" do
        ...
        post :create, {:charge => { "created" => "invalid value" }}, valid_session
        expect(assigns(:charge)).to be_a_new(Charge)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested charge" do
        ...
        expect_any_instance_of(Charge).to receive(:update).with({ "created" => "2014-01-17 15:12:25" })
        put :update, {:id => charge.to_param, :charge => { "created" => "2014-01-17 15:12:25" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the charge as @charge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Charge.any_instance.stub(:save).and_return(false)
        put :update, {:id => charge.to_param, :charge => { "created" => "invalid value" }}, valid_session
        expect(assigns(:charge)).to eq(charge)
      end
